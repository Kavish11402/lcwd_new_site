    ...
    return(
        ...
        <div>
            ...
            <Link href={`/course/${courseUrl}`}>
                ...
                <div className={"bg-stone-50 drop-shadow-xl rounded-3xl w-[21rem] h-[33rem] smd:w-[22rem] flex flex-col justify-between pb-6 transition-all ease-linear 2xl:hover:scale-105"}>
