        ...
        <div className={"relative"}>
            ...
            <div className={"z-40 h-[36rem] flex flex-col justify-center"}>
                ...
                <div className={"rounded-3xl drop-shadow-2xl w-80 lg:w-fit mx-auto  bg-zinc-400/30 lg:bg-zinc-300/40 backdrop-blur-2xl py-4"}>
                    ...
                    {
                        showLogo&&<Image className={"w-36 lg:w-48 mx-auto"} src={lcwdLogo} alt={"LCWD Logo"}/>
                    }

                    <h1 className={"text-center text-primary-dark text-4xl lg:text-7xl font-semibold px-5 lg:px-24 mt-3"}>{title}</h1>

                    <h1 className={"text-center text-white px-5 lg:px-0 font-semibold lg:text-2xl my-4"}>{subTitle}</h1>
