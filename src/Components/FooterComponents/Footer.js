      ...
      <div className={"bg-primary-light text-gray-700 py-5 cursor-default underline-offset-4 selection:bg-secondary-dark selection:text-white "} >
          ...
          <div className={"flex flex-col justify-center"}>
              ...
              <div className={"flex flex-col w-72  mx-auto"}>
                  ...
                  <Image className={"w-20 mx-auto mb-2"} src={lcwdLogo} alt={"LCWD LOGO"} />

                  <h1 className={"font-bold text-lg text-center underline mb-3"}> Learn Code With Durgesh </h1>
              ...
              {/* Products */}
              <div className={"flex flex-col justify-around py-4 px-3 mx-auto"}>
                  <h1 className={"font-semibold text-lg text-center underline"}> Products </h1>

                  <div>
                      {/* TODO -> LINK THESE COURSES */}
                      <p className={"my-3 text-sm"}>• Spring Boot Course </p>
                      <p className={"mb-3 text-sm"}>• Spring Boot Project Course </p>
                      <p className={"mb-3 text-sm"}>• Crash Courses </p>
              ...
              <div className={"flex flex-col justify-around py-4 px-3 mx-auto"}>
                  ...
                  <h1 className={"font-semibold text-lg text-center underline"}> Contact </h1>


                  <div className={"flex flex-row justify-center text-sm my-3"}>
                  ...
                  <div className={"flex flex-row justify-center text-sm mb-3"}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 mr-4">
                          <path
              ...
              <div className={"hidden rounded-full my-5 border-[1px] border-black mx-20"}></div>

              {/* Get in Touch Section */}
              <div className={"flex flex-col justify-around py-4 px-3 mx-auto"}>

                  <h1 className={"font-semibold text-lg text-center underline"}> Get In Touch </h1>

                  <div className={"mt-3 flex flex-row justify-center"}>
                      <div className={"flex flex-row text-sm mr-3"}>
                          <Image className={"w-5 mr-1"} src={youtubeLogo} alt={"youtubeLogo"} />
                          <a href={`https://www.youtube.com/learncodewithdurgesh`} rel={"noreferrer"} target={'_blank'}> YouTube </a>
                      </div>

                      <div className={"flex flex-row text-sm mr-3"}>
                          <Image className={"w-5 mr-1"} src={facebookLogo} alt={"facebookLogo"} />
                          <a href={`https://www.facebook.com/learncodewithdurgesh`} rel={'noreferrer'} target={'_blank'}>Facebook</a>
                      </div>

                      <div className={"flex flex-row text-sm mr-3"}>
                          <Image className={"w-5 mr-1"} src={instagramLogo} alt={"instagramLogo"} />
                          <a href={`https://instagram.com/durgesh_k_t`} rel={'noreferrer'} target={'_blank'}>Instagram</a>
                      </div>

                      <div className={"flex flex-row text-sm "}>
                          <Image className={"w-5 mr-1"} src={linkedinLogo} alt={"linkedinLogo"} />
          ...
          <div className={"border-[1px]  border-black my-2"}></div>
