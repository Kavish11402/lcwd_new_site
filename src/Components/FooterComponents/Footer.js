...
export default function Footer()
{
  ...
  return(
      <div className={"bg-primary-light text-gray-700 py-5 cursor-default underline-offset-4 selection:bg-secondary-dark selection:text-white px-5"} >
          ...
          <div className={"flex flex-col justify-center lg:flex-row lg:space-x-12"}>
              ...
              <div className={"flex flex-col w-72 mx-auto lg:mx-0"}>
                  ...
                  <Image className={"w-20 mx-auto mb-2 lg:w-20 xl:w-24"} src={lcwdLogo} alt={"LCWD LOGO"} />

                  <h1 className={"font-bold text-lg text-center underline mb-3 xl:text-xl"}> Learn Code With Durgesh </h1>

                  <p className={"text-justify lg:text-left xl:text-justify text-sm xl:text-base"}>
              ...
              <div className={"flex flex-col justify-around py-4 px-3 mx-auto lg:mx-0"}>
                  <h1 className={"font-semibold text-lg text-center underline xl:text-xl"}> Products </h1>

                  <div>
                      {/* TODO -> LINK THESE COURSES */}
                      <p className={"my-3 text-sm lg:mb-5 lg:my-0 xl:text-base"}>• Spring Boot Course </p>
                      <p className={"mb-3 text-sm lg:mb-5 xl:text-base"}>• Spring Boot Project Course </p>
                      <p className={"mb-3 text-sm lg:mb-5 xl:text-base"}>• Crash Courses </p>
                      <p className={"text-sm lg:text-base"}>• Advance Java J2EE </p>
                  </div>
              ...
              <div className={"flex flex-col justify-around py-4 px-3 mx-auto lg:mx-0"}>
                  ...
                  <h1 className={"font-semibold text-lg text-center underline xl:text-xl"}> Contact </h1>

                  <div className={"flex flex-row justify-start text-sm my-3 xl:text-base lg:my-0"}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 lg:w-6 lg:h-6 mr-4">
                  ...
                  <div className={"flex flex-row justify-start text-sm mb-3 xl:text-base lg:mb-0"}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 lg:w-6 lg:h-6 mr-4">
                          <path
                  ...
                  <div className={"flex flex-row justify-start text-sm mb-3 xl:text-base"}>
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 lg:w-6 lg:h-6 mr-4">
                          <path fillRule="evenodd"
                                d="M1.5 4.5a3 3 0 013-3h1.372c.86 0 1.61.586 1.819 1.42l1.105 4.423a1.875 1.875 0 01-.694 1.955l-1.293.97c-.135.101-.164.249-.126.352a11.285 11.285 0 006.697 6.697c.103.038.25.009.352-.126l.97-1.293a1.875 1.875 0 011.955-.694l4.423 1.105c.834.209 1.42.959 1.42 1.82V19.5a3 3 0 01-3 3h-2.25C8.552 22.5 1.5 15.448 1.5 6.75V4.5z"
                                clipRule="evenodd"
              ...
              <div className={"hidden lg:block rounded-full my-5 border border-black"}></div>

              {/* Get in Touch Section */}
              <div className={"flex flex-col justify-around py-4 px-3 mx-auto lg:mx-0"}>

                  <h1 className={"font-semibold text-lg text-center underline xl:text-xl"}> Get In Touch </h1>
                  ...
                  <div className={"mt-3 flex flex-row lg:flex-col justify-around h-full"}>
                      ...
                      <div className={"flex flex-row text-sm mr-3 xl:text-base"}>
                          <Image className={"w-5 lg:w-6 mr-1 lg:mr-4"} src={facebookLogo} alt={"facebookLogo"} />
                          <a href={`https://www.facebook.com/learncodewithdurgesh`} rel={'noreferrer'} target={'_blank'}>Facebook</a>
                      </div>

                      <div className={"flex flex-row text-sm mr-3 xl:text-base"}>
                          <Image className={"w-5 lg:w-6 mr-1 lg:mr-4"} src={instagramLogo} alt={"instagramLogo"} />
                          <a href={`https://instagram.com/durgesh_k_t`} rel={'noreferrer'} target={'_blank'}>Instagram</a>
                      </div>

                      <div className={"flex flex-row text-sm mr-3 xl:text-base"}>
                          <Image className={"w-5 lg:w-6 mr-1 lg:mr-4"} src={linkedinLogo} alt={"linkedinLogo"} />
