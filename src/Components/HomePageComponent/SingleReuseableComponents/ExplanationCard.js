...
{
  return(
      <div className={"w-[20rem] flex flex-col justify-center py-2 rounded-xl border-b-secondary-medium border-b-8 drop-shadow-xl bg-stone-100 sm:w-[28rem] sm:py-4 mx-auto"} >
