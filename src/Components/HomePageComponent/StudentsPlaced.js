      ...
      <div className={"py-10 flex flex-col lg:flex-row justify-around"}>
          ...
          <div className={"flex flex-col justify-center"}>
              ...
              <div className={"flex flex-row justify-center "}>
                  ...
                  <div className={"hidden lg:block border-4 rounded-3xl border-primary-dark"}></div>
                  <div className={"lg:pl-4 pt-5 pb-10  flex flex-col justify-center"}>
                      <p className={"text-4xl lg:text-6xl underline underline-offset-8 font-semibold text-primary-dark text-center lg:text-left"}>Placements</p>
          ...
          <div className={"relative w-fit"}>
              ...
              <div className={"w-screen lg:w-fit"}>
                  <Image className={"w-[325px] lg:w-[520px] mx-auto lg:mx-10 rotate-[30deg] animate-Image-Rotation"} src={CompanyCircle} alt={"Image"}/>
              </div>
