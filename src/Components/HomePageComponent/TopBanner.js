...
import bannerAnimation1 from "@/Assets/Images/banner_animation.gif";
  ...
  return (
    <div className={"flex flex-col lg:flex-row lg:h-[89vh]"}>
      <div className={"px-4 lg:w-1/2 lg:flex lg:flex-col lg:justify-center"}>
        <Image
          src={bannerAnimation1}
          alt={"Man With Computer"}
          className={"mx-auto w-[400px] md:w-[700px]  "}
        />
      </div>

      <div
        className={
          "hidden lg:inline-flex rounded-full lg:my-16 xl:my-24 border border-zinc-500"
        }
      ></div>
      ...
      <div className={"flex flex-col justify-center lg:w-1/2"}>
        ...
        <div
          className={
            "mt-1 flex flex-row justify-center font-semibold text-2xl lg:text-3xl xl:text-4xl text-zinc-600"
          }
        >
        ...
        <div
          className={
            "mt-10 flex flex-row justify-center font-semibold text-zinc-600 xl:mt-16"
          }
        >
          <Link
            target={"_blank"}
            href={"https://courses.learncodewithdurgesh.com/learn"}
          >
            <h1
              className={
        ...
        <div className={"mt-10 flex flex-col justify-center"}>
          <div className={"flex flex-row justify-center mb-2 xl:mb-4"}>
            <div className={"border-2 border-secondary-dark rounded-full mx-1"}>
              <svg
                className={"w-8 h-8 xl:w-10 xl:h-10 text-secondary-dark"}
