...
export default function ReviewHub() {
  return (
    <div>
      <HeroCard
        backgroundCss={"bg-reviewBannerImg"}
        title={"Our Reviews"}
        subTitle={"Reviews given by out Students"}
      ...
      <div className={"flex flex-col"}>
        ...
        <ReviewCard
          ReviewMsg={
            "Best Course👌👌👌 जीसको भी spring SpringBoot सिखना होगा durgesh sir से ही सिखे.👍 आसन भाषा मे पढायी है सब चिझे बेहेतरीन कोर्से❤‍🔥☝🏻🔥"
          }
        ...
        <ReviewCard
          ReviewMsg={
            "I learn lots of thing by this course. concept are very depth on spring boot. Thanks"
          }
        ...
        <ReviewCard
          ReviewMsg={
            "Trainer is very friendly with all of us which is very great as we are not hesitating to ask any doubts which makes this training complete in a very cool way. Thanks for the  great  effort you put to explain all the things in a very clear and concise way."
          }
        ...
        <ReviewCard
          ReviewMsg={
            "Best course with clear explanation in easy way to understand the spring framework"
          }
        ...
        <ReviewCard
          ReviewMsg={
            "Thank you so much sir, you have covered a lot of topics and continuously providing us with new other topics. Since I am a new learner, I found your videos and this batch very helpful. Your detailed explanation and patience are your strength, keep it up! Best wishes to you and your team!"
          }
        ...
        <ReviewCard
          ReviewMsg={
            "Superb sir love to take every course of yours Your knowledge and teaching is awesome"
          }
        ...
        <ReviewCard
          ReviewMsg={
            "Explained in very simple way.. Really helpful to learn backend completely.. Thank you sir"
          }
