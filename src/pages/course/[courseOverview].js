...
export default function CourseOverview({courseData , courseVideoData , codes})
{
    ...
    const [ tabIndexNo , setTabIndexNo ] = useState(1)
      ...
      <>
          ...
          <div className={""}>
              ...
              <div className={"bg-secondary-dark lg:min-h-[48rem] 2xl:min-h-[40rem] py-12 lg:pl-8 2xl:pl-24 relative"}>
                  ...
                  <div className={"lg:absolute lg:top-8 lg:right-8 xl:right-12 2xl:right-28 mt-14 lg:mt-0 py-8 bg-stone-300/70 backdrop-blur-lg h-[48rem] mx-auto w-[21rem] md:w-[36rem] lg:w-[27rem] xl:w-[36rem] rounded-3xl shadow-xl drop-shadow-2xl"}>
                      ...
                      {
                          ( codes.length!==0) && <a href={"#download-code"} onClick={ ()=>{ setTabIndexNo(2) } }>
                              <h2 className={"mt-5 bg-primary-medium hover:hover:scale-105 transition-all ease-in-out rounded-3xl py-2 text-center text-sm font-semibold text-zinc-600 md:text-lg w-48 lg:w-60 mx-auto"}>
              ...
              <div className={"mt-2 mb-28 lg:my-24 2xl:my-60"} >
                  ...
                  <Tab.Group selectedIndex={tabIndexNo} onChange={setTabIndexNo} defaultIndex={tabIndexNo} >

                      <Tab.List id={'download-code'} className={"flex flex-row justify-center"}>
                          ...
                          <Tab.Panel>
                              <div>
                                  <div className={"mx-5 lg:mx-16"}>
                                      ...
                                      <h1 className={"font-bold text-4xl underline underline-offset-8 text-center"}>Description of the Course</h1>
                          ...
                          <Tab.Panel>

                              {
                                  ...
                                  <div className={"mx-4 sm:mx-6"}>
                                      <h1 className={"font-bold mb-10 text-center lg:text-left text-4xl underline underline-offset-8 mx-auto w-fit"}>Source Code</h1>
